...
public class AssetsHelper {
	...
	public static void loadAsPortrait() {
		assumedWidth = 320;
		assumedHeight = 480;
		fixAssetResolutions();
	...
	public static void loadAsLandscape() {
...
//		music = Gdx.audio.newMusic(Gdx.files.getFileHandle("sounds/music.ogg", FileType.Internal));
//		
...
//		music.setVolume(Settings.musicVolume);
	...
	private static void fixAssetResolutions() {
		/**
		 * We assume landscape view and take width as a criteria Major width in consideration are 320, 480, 800, 960
		 * 
		 */
		...
		/*
		 * System.out.println("density:"+screenDensity); System.out.println("width:" +landscapeWidth+" height:"+landscapeHeight); System.out.println("PpcX:"
		 * +Gdx.graphics.getPpcX()+" PpcY:"+Gdx.graphics.getPpcY()); System.out.println ("PpiX:"+Gdx.graphics.getPpiX()+" PpiY:"+Gdx.graphics.getPpiY());
		 */
...
//		Settings.save();
	...
	public static void loadDefaults() {
		...
		/*
		 * assumedWidth=320; assumedHeight=240; usesDpi=usesLdpi;
		 */
		...
		/*
		 * assumedWidth=800; assumedHeight=480; usesDpi=usesHdpi;
		 */

		/*
		 * assumedWidth=960; assumedHeight=640; usesDpi=usesXdpi;
		 */
